...
function CreatePostDialog({ postCreated }: CreatePostDialogProps) {
    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className='fixed bg-secondary py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25'>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-4 mt-6'>
                    ...
                    <footer className='mt-7 flex justify-end gap-4'>
                        <Button type="submit" className='text-white font-semiboold flex-none w-48 h-12'>Postar</Button>
